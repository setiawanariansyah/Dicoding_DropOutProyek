...
encoder_KatMarital_status = joblib.load("Model/encoder_KatMarital_status.joblib")
encoder_KatApplication_mode = joblib.load("Model/encoder_KatApplication_mode.joblib")
encoder_KatCourse = joblib.load("Model/encoder_KatCourse.joblib")
encoder_Kat_PreviousQualification = joblib.load("Model/encoder_Kat_PreviousQualification.joblib")
encoder_KatNacionality = joblib.load("Model/encoder_KatNacionality.joblib")
encoder_Kat_MotherQualification = joblib.load("Model/encoder_Kat_MotherQualification.joblib")
encoder_Kat_FatherQualification = joblib.load("Model/encoder_Kat_FatherQualification.joblib")
encoder_Kat_FatherOccupation = joblib.load("Model/encoder_Kat_FatherOccupation.joblib")
encoder_Kat_MotherOccupation = joblib.load("Model/encoder_Kat_MotherOccupation.joblib")
